package jp.co.mukeisoftllc.ex.protobuf;
...
public final class EchoServiceGrpc {
  ...
  public static final String SERVICE_NAME = "protobuf.EchoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<jp.co.mukeisoftllc.ex.protobuf.EchoRequest,
      jp.co.mukeisoftllc.ex.protobuf.EchoResponse> getEchoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Echo",
      requestType = jp.co.mukeisoftllc.ex.protobuf.EchoRequest.class,
      responseType = jp.co.mukeisoftllc.ex.protobuf.EchoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<jp.co.mukeisoftllc.ex.protobuf.EchoRequest,
      jp.co.mukeisoftllc.ex.protobuf.EchoResponse> getEchoMethod() {
    io.grpc.MethodDescriptor<jp.co.mukeisoftllc.ex.protobuf.EchoRequest, jp.co.mukeisoftllc.ex.protobuf.EchoResponse> getEchoMethod;
      ...
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoMethod = EchoServiceGrpc.getEchoMethod) == null) {
          EchoServiceGrpc.getEchoMethod = getEchoMethod =
              io.grpc.MethodDescriptor.<jp.co.mukeisoftllc.ex.protobuf.EchoRequest, jp.co.mukeisoftllc.ex.protobuf.EchoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Echo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  jp.co.mukeisoftllc.ex.protobuf.EchoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  jp.co.mukeisoftllc.ex.protobuf.EchoResponse.getDefaultInstance()))
  ...
  public static abstract class EchoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void echo(jp.co.mukeisoftllc.ex.protobuf.EchoRequest request,
        io.grpc.stub.StreamObserver<jp.co.mukeisoftllc.ex.protobuf.EchoResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                jp.co.mukeisoftllc.ex.protobuf.EchoRequest,
                jp.co.mukeisoftllc.ex.protobuf.EchoResponse>(
                  this, METHODID_ECHO)))
          .build();
    }
  }
  ...
  public static final class EchoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EchoServiceBlockingStub> {
    ...
    /**
     */
    public jp.co.mukeisoftllc.ex.protobuf.EchoResponse echo(jp.co.mukeisoftllc.ex.protobuf.EchoRequest request) {
  ...
  public static final class EchoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EchoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<jp.co.mukeisoftllc.ex.protobuf.EchoResponse> echo(
        jp.co.mukeisoftllc.ex.protobuf.EchoRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO:
          serviceImpl.echo((jp.co.mukeisoftllc.ex.protobuf.EchoRequest) request,
              (io.grpc.stub.StreamObserver<jp.co.mukeisoftllc.ex.protobuf.EchoResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EchoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return jp.co.mukeisoftllc.ex.protobuf.Echo.getDescriptor();
    }
